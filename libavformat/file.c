...
static const AVOption file_options[] = {
    ...
    { "ijkapplication",   "AVApplicationContext", offsetof(FileContext, app_ctx_intptr),   AV_OPT_TYPE_INT64, { .i64 = 0 }, INT64_MIN, INT64_MAX, AV_OPT_FLAG_DECODING_PARAM },
    { NULL }
};
...
static int file_read(URLContext *h, unsigned char *buf, int size)
{
    ...
    if (ret > 0)
        av_application_did_io_tcp_read(c->app_ctx, (void*)h, ret);
